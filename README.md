...
Esta aplicación fue creada por [Estefania Cassingena Navone](https://twitter.com/EstefaniaCassN) Y modificada por mi (un poquito 😂). Su estructura inicial fue creada con el comando `npx create-react-app`.
